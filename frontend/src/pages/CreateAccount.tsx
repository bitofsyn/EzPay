...
import { User, CreateAccountData } from "../types"; // Import CreateAccountData
...
const CreateAccount: React.FC = () => {
    ...
    const handleCreateAccount = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const payload: CreateAccountData = { // Use CreateAccountData
            ...
            const errorMessage = (err as any).response?.data?.message || "계좌 생성 중 오류 발생";
